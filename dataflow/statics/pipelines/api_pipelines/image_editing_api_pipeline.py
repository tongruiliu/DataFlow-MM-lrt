...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help='Model name: for gemini format use "gemini-2.5-flash-image" or "gemini-3-pro-image-preview"; for openai format use "dall-e-2" or "gpt-image-1"'
    )
    parser.add_argument(
        '--batch_size',
        type=int,
    ...
    parser.add_argument(
        '--cache_path',
        type=str,
        default="./cache_local/image_edit_api",
        help='Cache path'
    )
